...
User_Marker.prototype.add_listener = function( )
{
    var marcador = this;
...
User_Marker.prototype.add_streetview_overlay_listener = function()
{
    var marcador = this;
...
User_Marker.prototype.mostrar_streetview_canvas = function(location){
...
User_Marker.prototype.updateUserPosition = function(location){
    
    var self = this;    
    application.geo.client_position = self.gmarker.getPosition();
}

User_Marker.prototype.has_infowindow = function(){
...
User_Marker.prototype.addInfowindow = function()
{
	var self = this;
...
User_Marker.prototype.add_chat_infowindow = function()
{
	var self = this;
...
User_Marker.prototype.showOptions = function(location,id)
{
    var self = this;
...
User_Marker.prototype.delete = function()
{
    var self = this;
	...
	var json = {
	   ...
	   message_type: 'removeUser_Marker',
	   marker_id: self.id
	   };
...
User_Marker.prototype.delete_from_other = function( )
{
    var self = this;
...
User_Marker.prototype.to_JSON = function( )
{
    var self = this;
...
User_Marker.prototype.get_position = function( )
{
    var self = this;
...
User_Marker.prototype.message_received = function( data )
{
    var self = this;
